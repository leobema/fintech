...
function FormSwap() {
    ...
    const calculatedValue2 = amount2 ? amount2 / ars : '';
    ...
    const handleAmountChange = (event) => {
        ...
        if (value > 0) {
          setAmount(value);
          setAmount2((value * ars).toFixed(2));
        } else {
          setAmount('');
          setAmount2('');
        }
...
<div className="mt-4 p-4 bg-gray-50 border rounded-lg">
  ...
  <form className="max-w-sm mx-auto">
              {!swapped ? (
                <>
                  <label id="coin2" className="block mt-4 text-sm font-medium text-gray-900 dark:text-white">Recibes:</label>
                  <input 
                    type="number" 
                    id="number-input" 
                  ...
                  <label id="coin3" className="block text-sm font-medium text-gray-900 dark:text-white">Depositas:</label>
                  <input 
                    type="number" 
                    id="number-input" 
                    aria-describedby="helper-text-explanation" 
                ...
                <>
                  <label id="coin3" className="block mt-4 text-sm font-medium text-gray-900 dark:text-white">Depositas:</label>
                  <input 
                    type="number" 
                    id="number-input" 
                    aria-describedby="helper-text-explanation" 
                  ...
                  <label id="coin2" className="block text-sm font-medium text-gray-900 dark:text-white">Recibes:</label>
                  <input 
                    type="number" 
                    id="number-input" 
                    aria-describedby="helper-text-explanation" 
